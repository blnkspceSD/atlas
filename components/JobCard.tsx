...
const JobCard: React.FC<JobCardProps> = ({ job }) => {
  ...
  return (
    <div className="bg-gray-100 rounded-2xl border-gray-300 overflow-hidden hover:shadow hover:bg-gray-200 transition-all pt-3 px-2 pb-2 flex flex-col h-full">
